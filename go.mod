...
replace (
	...
	sigs.k8s.io/kustomize/api => github.com/chlunde/kustomize/api v0.0.0-20231103202128-0728154b309e
	sigs.k8s.io/kustomize/kyaml => github.com/chlunde/kustomize/kyaml v0.0.0-20231103202128-0728154b309e
)
